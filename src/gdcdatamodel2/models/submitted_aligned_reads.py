...
class SubmittedAlignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Submitted Aligned Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing aligned reads that are used as input to GDC workflows.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_SubmittedAlignedReadsDataFromCoreMetadataCollection_out",
    ...
    @psqlgraph.pg_property(str , enum=['ATAC-Seq', 'Bisulfite-Seq', 'ChIP-Seq', 'HiChIP', 'RNA-Seq', 'Targeted Sequencing', 'WGS', 'WXS', 'm6A MeRIP-Seq', 'miRNA-Seq', 'scATAC-Seq', 'scBCR-Seq', 'scRNA-Seq', 'scTCR-Seq'])
