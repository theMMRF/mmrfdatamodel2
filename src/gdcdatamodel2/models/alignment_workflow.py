...
class AlignmentWorkflow(base.Node):
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aliquot": {
                    "edge_out": "_AlignmentWorkflowDataFromAliquot_out",
    ...
    @psqlgraph.pg_property(str , enum=['BWA', 'BWA with BQSR', 'BWA with Mark Duplicates and BQSR', 'BWA-aln', 'BWA-mem', 'CellRanger - 10x Chromium', 'STAR - Smart-Seq2', 'STAR 2-Pass', 'STAR 2-Pass Chimeric', 'STAR 2-Pass Genome', 'STAR 2-Pass Transcriptome', 'Unaligned', 'zUMIs - Smart-Seq2'])
