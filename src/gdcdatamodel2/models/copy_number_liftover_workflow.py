...
class CopyNumberLiftoverWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Copy Number Liftover Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the somatic copy number liftover workflow used to harmonize TCGA copy number data.', 'required': ['submitter_id', 'type', 'submitted_tangent_copy_numbers'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
