"""This module is for GermlineCopyNumberEstimateRelatesToCase Edge.
...
class GermlineCopyNumberEstimateRelatesToCase(base.Edge):
    __tablename__: str = "edge_36efef66_geconuesretoca"
    ...
    __dst_src_assoc__: str = "_related_germline_copy_number_estimate"
