"""This module is for GermlineCopyNumberWorkflow Node.
...
class GermlineCopyNumberWorkflow(base.Node):
    __tablename__: str = "node_germlinecopynumberworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Copy Number Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the Germline Copy Number pipeline used to estimate copy number changes from different molecular data sources.', 'required': ['submitter_id', 'type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_copy_number_workflow"
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                "aligned_reads_files": {
                    "backref": "germline_copy_number_workflows",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aligned_reads_files": {
                    "edge_out": "_GermlineCopyNumberWorkflowPerformedOnAlignedReads_out",
                    "dst_type": base.Node.get_subclass("aligned_reads"),
                },
                "submitted_genotyping_arrays": {
                    "edge_out": "_GermlineCopyNumberWorkflowPerformedOnSubmittedGenotypingArray_out",
    ...
    @psqlgraph.pg_property(str , enum=['ABSOLUTE GATK4 CNV Auto', 'ABSOLUTE GATK4 CNV Curated', 'ABSOLUTE LiftOver', 'ASCAT2', 'ASCAT3', 'AscatNGS', 'GATK4 CNV', 'ichorCNA'])
    def workflow_type(self, value):
        self._set_property("workflow_type", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(GermlineCopyNumberWorkflow)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineCopyNumberWorkflow)
