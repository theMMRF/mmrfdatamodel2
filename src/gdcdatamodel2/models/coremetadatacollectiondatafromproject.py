"""This module is for CoreMetadataCollectionDataFromProject Edge.
...
class CoreMetadataCollectionDataFromProject(base.Edge):
    __tablename__: str = "edge_9197510c_comecodafrpr"

    __label__: str = "data_from"
    __dst_class__: str = "Project"
    __dst_table__: str = "node_project"
    __src_class__: str = "CoreMetadataCollection"
    __src_table__: str = "node_coremetadatacollection"

    __dst_src_assoc__: str = "core_metadata_collections"
