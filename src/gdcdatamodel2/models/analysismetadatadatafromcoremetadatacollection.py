"""This module is for AnalysisMetadataDataFromCoreMetadataCollection Edge.
...
class AnalysisMetadataDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_319a0451_anmedafrcomeco"
