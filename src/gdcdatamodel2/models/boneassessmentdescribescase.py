"""This module is for BoneAssessmentDescribesCase Edge.
...
class BoneAssessmentDescribesCase(base.Edge):
    __tablename__: str = "edge_boneassessmentdescribescase"
    ...
    __dst_src_assoc__: str = "bone_assessment"
