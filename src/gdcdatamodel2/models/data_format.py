...
class DataFormat(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Format', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': True, 'downloadable': True, 'description': 'Data format of a legacy file (deprecated).', 'required': ['name', 'files', 'submitter_id', 'type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "files": {
                    "edge_out": "_DataFormatDescribesFile_out",
