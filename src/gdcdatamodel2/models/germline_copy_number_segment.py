"""This module is for GermlineCopyNumberSegment Node.
...
class GermlineCopyNumberSegment(base.Node):
    __tablename__: str = "node_germlinecopynumbersegment"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Copy Number Segment', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing the copy number data from a copy number liftover workflow. Contains all copy numbers detected.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_copy_number_segment"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                "germline_copy_number_variation_workflows": {
                    "name": "germline_copy_number_segments",
                    "src_type": base.Node.get_subclass("germline_copy_number_variation_workflow"),
                },
        }
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                ...
                "germline_copy_number_variation_workflows": {
                    "backref": "germline_copy_number_segments",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_GermlineCopyNumberSegmentDataFromCoreMetadataCollection_out",
                    "dst_type": base.Node.get_subclass("core_metadata_collection"),
                },
                "genomic_profile_harmonization_workflows": {
                    "edge_out": "_GermlineCopyNumberSegmentDerivedFromGenomicProfileHarmonizationWorkflow_out",
                    "dst_type": base.Node.get_subclass("genomic_profile_harmonization_workflow"),
                },
                "germline_copy_number_workflows": {
                    "edge_out": "_GermlineCopyNumberSegmentDerivedFromGermlineCopyNumberWorkflow_out",
    ...
    @psqlgraph.pg_property(str , enum=['Copy Number Variation', 'Germline Copy Number Variation'])
    def data_category(self, value):
        self._set_property("data_category", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['SEG', 'TXT'])
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Allele-specific Copy Number Segment', 'Copy Number Segment', 'Germline Copy Number Segment', 'Masked Copy Number Segment'])
...
datetime_hooks.cls_inject_created_datetime_hook(GermlineCopyNumberSegment)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineCopyNumberSegment)
