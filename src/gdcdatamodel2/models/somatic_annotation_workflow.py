...
class SomaticAnnotationWorkflow(base.Node):
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aligned_reads_files": {
                    "edge_out": "_SomaticAnnotationWorkflowPerformedOnAlignedReads_out",
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan Annotation', 'FoundationOne Annotation', 'GATK4 MuTect2 Annotation', 'GATK4 MuTect2 Tumor-Only Annotation', 'Manta Indel Annotation', 'MuSE Annotation', 'MuTect2 Annotation', 'Pindel Annotation', 'SNPeff', 'SomaticSniper Annotation', 'Strelka2 Annotation', 'SvABA Indel Annotation', 'VEP', 'VarScan2 Annotation'])
