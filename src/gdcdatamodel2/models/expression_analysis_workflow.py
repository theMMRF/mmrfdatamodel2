...
class ExpressionAnalysisWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Expression Analysis Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the expression analysis workflow used to generate additional analysis on top of the gene expression data.', 'required': ['submitter_id', 'type', 'gene_expressions'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
