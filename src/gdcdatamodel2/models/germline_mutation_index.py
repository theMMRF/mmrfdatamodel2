...
class GermlineMutationIndex(base.Node):
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_GermlineMutationIndexDataFromCoreMetadataCollection_out",
                    "dst_type": base.Node.get_subclass("core_metadata_collection"),
                },
                "germline_structural_variations": {
                    "edge_out": "_GermlineMutationIndexDerivedFromGermlineStructuralVariation_out",
                    "dst_type": base.Node.get_subclass("germline_structural_variation"),
                },
                "simple_germline_variations": {
    ...
    @psqlgraph.pg_property(str , enum=['Germline Structural Variation', 'Simple Nucleotide Variation'])
    def data_category(self, value):
        self._set_property("data_category", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['CSI', 'TBI'])
