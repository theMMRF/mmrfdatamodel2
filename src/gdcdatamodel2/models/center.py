...
class Center(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Center', 'namespace': 'https://gdc.cancer.gov', 'category': 'administrative', 'submittable': True, 'downloadable': True, 'description': 'A Professional Organization or Group which has or is able to submit data to the GDC that are valid with respect to GDC prescribed or defined data formats. (GDC subclass of NCIt C19711)', 'required': ['submitter_id', 'type', 'projects'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "projects": {
                    "edge_out": "_CenterDescribesProject_out",
