...
class File(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'File', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'A set of related records (either written or electronic) kept together. (NCIt C42883)', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                "data_formats": {
                    "name": "files",
                    "src_type": base.Node.get_subclass("data_format"),
                },
                "data_types": {
                    "name": "files",
                    "src_type": base.Node.get_subclass("data_type"),
                },
                "experimental_strategies": {
                    "name": "files",
                    "src_type": base.Node.get_subclass("experimental_strategy"),
                },
                "platforms": {
                    "name": "files",
                    "src_type": base.Node.get_subclass("platform"),
                },
                "tags": {
                    "name": "files",
                    "src_type": base.Node.get_subclass("tag"),
                },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                ...
                "core_metadata_collections": {
                    "edge_out": "_FileDataFromCoreMetadataCollection_out",
    ...
    def data_subtypes(self, value):
        self._set_property("data_subtypes", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property()
    def centers(self, value):
        self._set_property("centers", value)  # type: ignore  # inherited from CommonBase
