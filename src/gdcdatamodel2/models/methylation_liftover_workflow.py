...
class MethylationLiftoverWorkflow(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Methylation Liftover Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the methylation liftover workflow used to harmonize TCGA methylation data.', 'required': ['submitter_id', 'type', 'submitted_methylation_beta_values'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
