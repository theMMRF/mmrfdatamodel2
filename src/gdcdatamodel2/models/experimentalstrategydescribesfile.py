"""This module is for ExperimentalStrategyDescribesFile Edge.
...
class ExperimentalStrategyDescribesFile(base.Edge):
    __tablename__: str = "edge_experimentalstrategydescribesfile"

    __label__: str = "describes"
    __dst_class__: str = "File"
    __dst_table__: str = "node_file"
    __src_class__: str = "ExperimentalStrategy"
    __src_table__: str = "node_experimentalstrategy"

    __dst_src_assoc__: str = "experimental_strategies"
