"""This module is for GermlineCopyNumberAuxiliaryFile Node.
...
class GermlineCopyNumberAuxiliaryFile(base.Node):
    __tablename__: str = "node_germlinecopynumberauxiliaryfile"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Copy Number Auxiliary File', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file related to the copy number pipeline that contains any outputs not strictly defined in other nodes', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_copy_number_auxiliary_file"
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                "core_metadata_collections": {
                    "backref": "germline_copy_number_auxiliary_files",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_GermlineCopyNumberAuxiliaryFileDataFromCoreMetadataCollection_out",
                    "dst_type": base.Node.get_subclass("core_metadata_collection"),
                },
                "germline_copy_number_workflows": {
                    "edge_out": "_GermlineCopyNumberAuxiliaryFileDerivedFromGermlineCopyNumberWorkflow_out",
    ...
    @psqlgraph.pg_property(str , enum=['PDF', 'TAR', 'TSV'])
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['CNV Model', 'Intermediate Analysis Archive', 'Intermediate Analysis File'])
...
datetime_hooks.cls_inject_created_datetime_hook(GermlineCopyNumberAuxiliaryFile)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineCopyNumberAuxiliaryFile)
