"""This module is for TagDescribesFile Edge.
...
class TagDescribesFile(base.Edge):
    __tablename__: str = "edge_tagdescribesfile"

    __label__: str = "describes"
    __dst_class__: str = "File"
    __dst_table__: str = "node_file"
    __src_class__: str = "Tag"
    __src_table__: str = "node_tag"

    __dst_src_assoc__: str = "tags"
