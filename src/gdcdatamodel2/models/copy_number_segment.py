...
class CopyNumberSegment(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Somatic Copy Number Segment', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing the somatic copy number data from a copy number liftover workflow. Contains all copy numbers detected.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                ...
                "core_metadata_collections": {
                    "edge_out": "_CopyNumberSegmentDataFromCoreMetadataCollection_out",
    ...
    @psqlgraph.pg_property(str , enum=['Copy Number Variation', 'Somatic Copy Number Variation'])
    ...
    @psqlgraph.pg_property(str , enum=['Allele-specific Copy Number Segment', 'Copy Number Segment', 'Masked Copy Number Segment', 'Somatic Copy Number Segment'])
