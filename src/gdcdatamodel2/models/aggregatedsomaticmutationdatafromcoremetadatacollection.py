"""This module is for AggregatedSomaticMutationDataFromCoreMetadataCollection Edge.
...
class AggregatedSomaticMutationDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_26cf7a25_agsomudafrcomeco"
