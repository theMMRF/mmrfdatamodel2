"""This module is for CgsRiskKeyCriteriaRelatesToCase Edge.
...
class CgsRiskKeyCriteriaRelatesToCase(base.Edge):
    __tablename__: str = "edge_cgsriskkeycriteriarelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "CgsRiskKeyCriteria"
    __src_table__: str = "node_cgsriskkeycriteria"

    __dst_src_assoc__: str = "_related_cgs_risk_key_criteria"
