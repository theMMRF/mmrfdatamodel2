...
class Portion(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Portion', 'namespace': 'https://gdc.cancer.gov', 'category': 'biospecimen', 'submittable': True, 'downloadable': True, 'description': 'A physical sub-part of any sample.', 'required': ['submitter_id', 'type', 'samples'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
