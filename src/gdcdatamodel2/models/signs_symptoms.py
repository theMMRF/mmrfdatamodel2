"""This module is for SignsSymptoms Node.
...
class SignsSymptoms(base.Node):
    __tablename__: str = "node_signssymptoms"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Signs and Symptoms', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': True, 'description': 'TK', 'required': ['submitter_id', 'type', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "cases": {
                    "edge_out": "_SignsSymptomsDescribesCase_out",
    ...
    @psqlgraph.pg_property(str )
    def anemia(self, value):
        self._set_property("anemia", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def bone_lesion(self, value):
        self._set_property("bone_lesion", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def lytic_bone_lesion(self, value):
        self._set_property("lytic_bone_lesion", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def plasmacytoma_number(self, value):
        self._set_property("plasmacytoma_number", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def soft_tissue_plasmacytoma_found_ct_mri(self, value):
        self._set_property("soft_tissue_plasmacytoma_found_ct_mri", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def soft_tissue_plasmacytoma_multi(self, value):
        self._set_property("soft_tissue_plasmacytoma_multi", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def soft_tissue_plasmacytoma_single(self, value):
        self._set_property("soft_tissue_plasmacytoma_single", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(SignsSymptoms)
datetime_hooks.cls_inject_updated_datetime_hook(SignsSymptoms)
