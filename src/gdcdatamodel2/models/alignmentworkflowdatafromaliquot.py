"""This module is for AlignmentWorkflowDataFromAliquot Edge.
...
class AlignmentWorkflowDataFromAliquot(base.Edge):
    __tablename__: str = "edge_alignmentworkflowdatafromaliquot"
    ...
    __dst_src_assoc__: str = "alignment_workflow"
    __src_dst_assoc__: str = "aliquot"
