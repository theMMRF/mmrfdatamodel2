...
class DataRelease(base.Node):
    ...
    _defaults:  Dict[str, Union[bool, float, int, str]] = {'state': 'validated', 'released': False}
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Release', 'namespace': 'https://gen3.org', 'category': 'administrative', 'submittable': True, 'description': 'Internal node to store different data releases.', 'required': ['submitter_id', 'type', 'projects'], 'project': '*', 'program': '*'}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "projects": {
                    "edge_out": "_DataReleaseDataFromProject_out",
