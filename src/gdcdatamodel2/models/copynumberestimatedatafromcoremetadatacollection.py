"""This module is for CopyNumberEstimateDataFromCoreMetadataCollection Edge.
...
class CopyNumberEstimateDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_a5750610_conuesdafrcomeco"
