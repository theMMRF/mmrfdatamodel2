"""This module is for GermlineCopyNumberVariationWorkflowRelatesToCase Edge.
...
class GermlineCopyNumberVariationWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_a48cae7c_geconuvaworetoca"
    ...
    __dst_src_assoc__: str = "_related_germline_copy_number_variation_workflow"
