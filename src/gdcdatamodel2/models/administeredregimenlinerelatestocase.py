"""This module is for AdministeredRegimenLineRelatesToCase Edge.
...
class AdministeredRegimenLineRelatesToCase(base.Edge):
    __tablename__: str = "edge_6234d112_adreliretoca"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "AdministeredRegimenLine"
    __src_table__: str = "node_administeredregimenline"

    __dst_src_assoc__: str = "_related_administered_regimen_line"
