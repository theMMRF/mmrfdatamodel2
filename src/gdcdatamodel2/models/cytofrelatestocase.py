"""This module is for CytofRelatesToCase Edge.
...
class CytofRelatesToCase(base.Edge):
    __tablename__: str = "edge_cytofrelatestocase"
    ...
    __dst_src_assoc__: str = "_related_cytof"
