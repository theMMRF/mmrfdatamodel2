...
class SubmittedUnalignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Unaligned Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing unaligned reads that have not been harmonized.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aliquots": {
                    "edge_out": "_SubmittedUnalignedReadsDerivedFromAliquot_out",
                    "dst_type": base.Node.get_subclass("aliquot"),
                },
                "core_metadata_collections": {
                    "edge_out": "_SubmittedUnalignedReadsDataFromCoreMetadataCollection_out",
