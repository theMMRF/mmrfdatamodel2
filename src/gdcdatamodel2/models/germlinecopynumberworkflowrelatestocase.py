"""This module is for GermlineCopyNumberWorkflowRelatesToCase Edge.
...
class GermlineCopyNumberWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_5c892644_geconuworetoca"
    ...
    __dst_src_assoc__: str = "_related_germline_copy_number_workflow"
