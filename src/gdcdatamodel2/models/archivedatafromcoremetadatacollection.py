"""This module is for ArchiveDataFromCoreMetadataCollection Edge.
...
class ArchiveDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_54b96522_ardafrcomeco"
