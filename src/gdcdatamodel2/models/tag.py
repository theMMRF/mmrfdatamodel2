...
class Tag(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Tag', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': True, 'downloadable': True, 'description': 'Any comment or other information about an entity (deprecated).', 'required': ['name', 'submitter_id', 'type', 'files'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "files": {
                    "edge_out": "_TagDescribesFile_out",
