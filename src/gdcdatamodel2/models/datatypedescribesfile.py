"""This module is for DataTypeDescribesFile Edge.
...
class DataTypeDescribesFile(base.Edge):
    __tablename__: str = "edge_datatypedescribesfile"

    __label__: str = "describes"
    __dst_class__: str = "File"
    __dst_table__: str = "node_file"
    __src_class__: str = "DataType"
    __src_table__: str = "node_datatype"

    __dst_src_assoc__: str = "data_types"
