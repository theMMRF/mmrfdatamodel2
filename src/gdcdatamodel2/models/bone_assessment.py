"""This module is for BoneAssessment Node.
...
class BoneAssessment(base.Node):
    __tablename__: str = "node_boneassessment"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Bone Assessment', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': True, 'description': 'TK', 'required': ['submitter_id', 'type', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "cases": {
                    "edge_out": "_BoneAssessmentDescribesCase_out",
    ...
    @psqlgraph.pg_property(str )
    def lytic_bone_lesion_present(self, value):
        self._set_property("lytic_bone_lesion_present", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_femur(self, value):
        self._set_property("mm_bone_lesion_femur", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_humerus(self, value):
        self._set_property("mm_bone_lesion_humerus", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_pelvis(self, value):
        self._set_property("mm_bone_lesion_pelvis", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_ribs(self, value):
        self._set_property("mm_bone_lesion_ribs", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_skull(self, value):
        self._set_property("mm_bone_lesion_skull", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def mm_bone_lesion_spine(self, value):
        self._set_property("mm_bone_lesion_spine", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def number_of_lytic_lesions(self, value):
        self._set_property("number_of_lytic_lesions", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def osteopenia_osteoporosis(self, value):
        self._set_property("osteopenia_osteoporosis", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(BoneAssessment)
datetime_hooks.cls_inject_updated_datetime_hook(BoneAssessment)
