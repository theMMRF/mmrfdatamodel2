"""This module is for FilteredCopyNumberSegmentDataFromCoreMetadataCollection Edge.
...
class FilteredCopyNumberSegmentDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_b5ae4327_ficonusedafrcomeco"
