...
class DataSubtype(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Data Subtype', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': True, 'downloadable': True, 'description': 'Data subtype of a legacy file (deprecated).', 'required': ['name', 'data_types', 'submitter_id', 'type'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
