...
class MaskedSomaticMutation(base.Node):
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_MaskedSomaticMutationDataFromCoreMetadataCollection_out",
