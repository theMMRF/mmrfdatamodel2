"""This module is for GermlineStructuralVariationRelatesToCase Edge.
...
class GermlineStructuralVariationRelatesToCase(base.Edge):
    __tablename__: str = "edge_6fc670cd_gestvaretoca"
    ...
    __dst_src_assoc__: str = "_related_germline_structural_variation"
