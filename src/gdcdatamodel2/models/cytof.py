...
class Cytof(base.Node):
    __tablename__: str = "node_cytof"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Raw Flow Cytometry', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data files from Cytometry by Time-Of-Flight (CyTOF) analysis.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aliquots": {
                    "edge_out": "_CytofDerivedFromAliquot_out",
                    "dst_type": base.Node.get_subclass("aliquot"),
                },
                "core_metadata_collections": {
                    "edge_out": "_CytofDataFromCoreMetadataCollection_out",
    ...
    @psqlgraph.pg_property(str , enum=['Not Reported', 'Other', 'Unknown'])
    def instrument_model(self, value):
        self._set_property("instrument_model", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Other'])
    def platform(self, value):
        self._set_property("platform", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(Cytof)
datetime_hooks.cls_inject_updated_datetime_hook(Cytof)
