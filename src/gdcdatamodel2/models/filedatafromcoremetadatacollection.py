"""This module is for FileDataFromCoreMetadataCollection Edge.
...
class FileDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_filedatafromcoremetadatacollection"
