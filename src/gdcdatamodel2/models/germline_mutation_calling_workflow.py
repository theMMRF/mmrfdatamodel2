...
class GermlineMutationCallingWorkflow(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['Birdseed', 'DeepVariant', 'ExpansionHunter', 'HaplotypeCaller', 'Strelka2 Germline'])
