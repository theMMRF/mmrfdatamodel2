...
class AlignedReads(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Sequencing Reads', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing aligned and unaligned reads', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                ...
                "germline_copy_number_workflows": {
                    "name": "aligned_reads_files",
                    "src_type": base.Node.get_subclass("germline_copy_number_workflow"),
                },
                ...
                "germline_structural_variant_calling_workflows": {
                    "name": "aligned_reads_files",
                    "src_type": base.Node.get_subclass("germline_structural_variant_calling_workflow"),
                },
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                ...
                "core_metadata_collections": {
                    "edge_out": "_AlignedReadsDataFromCoreMetadataCollection_out",
    ...
    @psqlgraph.pg_property(str , enum=['BAM', 'CRAM'])
    def data_format(self, value):
        self._set_property("data_format", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=['Aligned Reads', 'Unaligned Reads'])
    def data_type(self, value):
        self._set_property("data_type", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=["3' scRNA-Seq", "5' scRNA-Seq", 'ATAC-Seq', 'Bisulfite-Seq', 'ChIP-Seq', 'HiChIP', 'RNA-Seq', 'Targeted Sequencing', 'Validation', 'WGS', 'WXS', 'm6A MeRIP-Seq', 'miRNA-Seq', 'scATAC-Seq', 'scBCR-Seq', 'scRNA-Seq', 'scTCR-Seq'])
