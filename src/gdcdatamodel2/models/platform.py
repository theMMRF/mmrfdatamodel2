...
class Platform(base.Node):
    ...
    __pg_secondary_keys: List[List[str]] = [['name'], ['project_id', 'submitter_id']]
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Platform', 'namespace': 'https://gdc.cancer.gov', 'category': 'TBD', 'submittable': True, 'downloadable': True, 'description': 'Any distinct technology (laboratory or computational) from which data may be obtained as files. (GDC) (deprecated).', 'required': ['name', 'submitter_id', 'type', 'files'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "files": {
                    "edge_out": "_PlatformDescribesFile_out",
