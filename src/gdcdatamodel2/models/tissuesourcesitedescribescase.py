"""This module is for TissueSourceSiteDescribesCase Edge.
...
class TissueSourceSiteDescribesCase(base.Edge):
    __tablename__: str = "edge_tissuesourcesitedescribescase"

    __label__: str = "describes"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "TissueSourceSite"
    __src_table__: str = "node_tissuesourcesite"

    __dst_src_assoc__: str = "tissue_source_sites"
