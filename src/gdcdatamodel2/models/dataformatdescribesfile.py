"""This module is for DataFormatDescribesFile Edge.
...
class DataFormatDescribesFile(base.Edge):
    __tablename__: str = "edge_dataformatdescribesfile"

    __label__: str = "describes"
    __dst_class__: str = "File"
    __dst_table__: str = "node_file"
    __src_class__: str = "DataFormat"
    __src_table__: str = "node_dataformat"

    __dst_src_assoc__: str = "data_formats"
