...
class Aliquot(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['CID-001', 'CID-005'])
    def dataset(self, value):
        self._set_property("dataset", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str , enum=["3' scRNA-seq", "5' scRNA-seq"])
    ...
    @psqlgraph.pg_property(str , enum=['Site 1', 'Site 2', 'Site 3', 'Site 4', 'Site 5', 'Unknown'])
    def site_code(self, value):
        self._set_property("site_code", value)  # type: ignore  # inherited from CommonBase
