"""This module is for GermlineCopyNumberSegmentRelatesToCase Edge.
...
class GermlineCopyNumberSegmentRelatesToCase(base.Edge):
    __tablename__: str = "edge_30c14799_geconuseretoca"
    ...
    __dst_src_assoc__: str = "_related_germline_copy_number_segment"
