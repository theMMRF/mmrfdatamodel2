"""This module is for CgsRiskKeyCriteriaDescribesCase Edge.
...
class CgsRiskKeyCriteriaDescribesCase(base.Edge):
    __tablename__: str = "edge_cgsriskkeycriteriadescribescase"
    ...
    __dst_src_assoc__: str = "cgs_risk_key_criteria"
