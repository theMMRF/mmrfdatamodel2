"""This module is for SimpleGermlineVariationDataFromCoreMetadataCollection Edge.
...
class SimpleGermlineVariationDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_32dd5475_sigevadafrcomeco"
