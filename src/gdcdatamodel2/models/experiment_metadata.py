...
class ExperimentMetadata(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Experiment Metadata', 'namespace': 'https://gdc.cancer.gov', 'category': 'metadata_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing the metadata for the experiment performed.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_ExperimentMetadataDataFromCoreMetadataCollection_out",
