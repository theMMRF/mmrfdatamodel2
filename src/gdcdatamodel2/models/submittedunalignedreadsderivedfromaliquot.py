"""This module is for SubmittedUnalignedReadsDerivedFromAliquot Edge.
...
class SubmittedUnalignedReadsDerivedFromAliquot(base.Edge):
    __tablename__: str = "edge_16731586_suunredefral"
