"""This module is for SignsSymptomsRelatesToCase Edge.
...
class SignsSymptomsRelatesToCase(base.Edge):
    __tablename__: str = "edge_signssymptomsrelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "SignsSymptoms"
    __src_table__: str = "node_signssymptoms"

    __dst_src_assoc__: str = "_related_signs_symptoms"
