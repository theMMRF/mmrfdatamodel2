"""This module is for GermlineCopyNumberVariationWorkflow Node.
...
class GermlineCopyNumberVariationWorkflow(base.Node):
    __tablename__: str = "node_germlinecopynumbervariationworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Copy Number Variation Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the Germline Copy Number Variation pipeline used to estimate copy number changes from different molecular data sources.', 'required': ['submitter_id', 'type', 'germline_copy_number_segments'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_copy_number_variation_workflow"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                "germline_copy_number_estimates": {
                    "name": "germline_copy_number_variation_workflows",
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                "germline_copy_number_estimates": {
                    "backref": "germline_copy_number_variation_workflows",
                    "type": base.Node.get_subclass("germline_copy_number_estimate"),
                },
                "germline_copy_number_segments": {
                    "backref": "germline_copy_number_variation_workflows",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "germline_copy_number_segments": {
                    "edge_out": "_GermlineCopyNumberVariationWorkflowPerformedOnGermlineCopyNumberSegment_out",
                    "dst_type": base.Node.get_subclass("germline_copy_number_segment"),
                },
        }
    ...
    @psqlgraph.pg_property(str , enum=['GISTIC', 'GISTIC - Arm Level Copy Number', 'GISTIC - Copy Number Score', 'GISTIC - Focal Amplification', 'GISTIC - Focal Deletion'])
    def workflow_type(self, value):
        self._set_property("workflow_type", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(GermlineCopyNumberVariationWorkflow)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineCopyNumberVariationWorkflow)
