"""This module is for Outcomes Node.
...
class Outcomes(base.Node):
    __tablename__: str = "node_outcomes"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Outcomes', 'namespace': 'https://gdc.cancer.gov', 'category': 'clinical', 'submittable': True, 'downloadable': True, 'description': 'TK', 'required': ['submitter_id', 'type', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "cases": {
                    "edge_out": "_OutcomesDescribesCase_out",
    ...
    @psqlgraph.pg_property(str )
    def censor_os(self, value):
        self._set_property("censor_os", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(str )
    def censor_pfs(self, value):
        self._set_property("censor_pfs", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(int )
    def surivival_time_os(self, value):
        self._set_property("surivival_time_os", value)  # type: ignore  # inherited from CommonBase


    @psqlgraph.pg_property(int )
    def survival_time_pfs(self, value):
        self._set_property("survival_time_pfs", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(Outcomes)
datetime_hooks.cls_inject_updated_datetime_hook(Outcomes)
