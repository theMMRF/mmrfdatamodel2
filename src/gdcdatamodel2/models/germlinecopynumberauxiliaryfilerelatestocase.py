"""This module is for GermlineCopyNumberAuxiliaryFileRelatesToCase Edge.
...
class GermlineCopyNumberAuxiliaryFileRelatesToCase(base.Edge):
    __tablename__: str = "edge_6875b398_geconuaufiretoca"
    ...
    __dst_src_assoc__: str = "_related_germline_copy_number_auxiliary_file"
