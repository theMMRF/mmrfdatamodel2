"""This module is for OutcomesRelatesToCase Edge.
...
class OutcomesRelatesToCase(base.Edge):
    __tablename__: str = "edge_outcomesrelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "Outcomes"
    __src_table__: str = "node_outcomes"

    __dst_src_assoc__: str = "_related_outcomes"
