"""This module is for GermlineStructuralVariantCallingWorkflow Node.
...
class GermlineStructuralVariantCallingWorkflow(base.Node):
    __tablename__: str = "node_germlinestructuralvariantcallingworkflow"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Structural Variant Calling Workflow', 'namespace': 'https://gdc.cancer.gov', 'category': 'analysis', 'submittable': True, 'downloadable': True, 'description': 'Metadata for the germline structural variant calling pipeline used to call germline structural variants in the DNA-Seq or RNA-Seq pipelines.', 'required': ['submitter_id', 'type', 'aligned_reads_files'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_structural_variant_calling_workflow"
    ...
    def populate_pg_backrefs(cls) -> None:
        ...
        cls._pg_backrefs = {
                "germline_structural_variations": {
                    "name": "germline_structural_variant_calling_workflows",
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "aligned_reads_files": {
                    "edge_out": "_GermlineStructuralVariantCallingWorkflowPerformedOnAlignedReads_out",
    ...
    @psqlgraph.pg_property(str , enum=['Arriba', 'BRASS', 'Delly', 'Fusion Catcher', 'Manta', 'Pairoscope', 'Pizzly', 'STAR-Fusion', 'SvABA'])
    def workflow_type(self, value):
        self._set_property("workflow_type", value)  # type: ignore  # inherited from CommonBase



datetime_hooks.cls_inject_created_datetime_hook(GermlineStructuralVariantCallingWorkflow)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineStructuralVariantCallingWorkflow)
