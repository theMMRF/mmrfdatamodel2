"""This module is for StructuralVariationDataFromCoreMetadataCollection Edge.
...
class StructuralVariationDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_c025e63a_stvadafrcomeco"
