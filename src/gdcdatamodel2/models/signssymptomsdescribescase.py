"""This module is for SignsSymptomsDescribesCase Edge.
...
class SignsSymptomsDescribesCase(base.Edge):
    __tablename__: str = "edge_signssymptomsdescribescase"
    ...
    __dst_src_assoc__: str = "signs_symptoms"
