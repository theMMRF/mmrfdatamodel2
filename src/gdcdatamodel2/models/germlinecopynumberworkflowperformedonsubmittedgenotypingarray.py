"""This module is for GermlineCopyNumberWorkflowPerformedOnSubmittedGenotypingArray Edge.
...
class GermlineCopyNumberWorkflowPerformedOnSubmittedGenotypingArray(base.Edge):
    __tablename__: str = "edge_c5472dda_geconuwopeonsugear"
