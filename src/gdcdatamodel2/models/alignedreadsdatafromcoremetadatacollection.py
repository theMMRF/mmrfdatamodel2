"""This module is for AlignedReadsDataFromCoreMetadataCollection Edge.
...
class AlignedReadsDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_d0f931be_alredafrcomeco"
