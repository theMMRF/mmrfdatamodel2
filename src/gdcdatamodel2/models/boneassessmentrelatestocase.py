"""This module is for BoneAssessmentRelatesToCase Edge.
...
class BoneAssessmentRelatesToCase(base.Edge):
    __tablename__: str = "edge_boneassessmentrelatestocase"

    __label__: str = "relates_to"
    __dst_class__: str = "Case"
    __dst_table__: str = "node_case"
    __src_class__: str = "BoneAssessment"
    __src_table__: str = "node_boneassessment"

    __dst_src_assoc__: str = "_related_bone_assessment"
