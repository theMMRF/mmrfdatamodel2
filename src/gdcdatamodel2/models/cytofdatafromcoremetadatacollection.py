"""This module is for CytofDataFromCoreMetadataCollection Edge.
...
class CytofDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_cytofdatafromcoremetadatacollection"

    __label__: str = "data_from"
    __dst_class__: str = "CoreMetadataCollection"
    __dst_table__: str = "node_coremetadatacollection"
    __src_class__: str = "Cytof"
    __src_table__: str = "node_cytof"

    __dst_src_assoc__: str = "cytof_files"
