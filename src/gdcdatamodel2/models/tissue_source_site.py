...
class TissueSourceSite(base.Node):
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Tissue Source Site', 'namespace': 'https://gdc.cancer.gov', 'category': 'administrative', 'submittable': True, 'downloadable': True, 'description': 'A clinical site that collects and provides patient samples and clinical metadata for research use. (NCIt C103264)', 'required': ['submitter_id', 'type', 'cases'], 'project': '*', 'program': '*', 'previous_version_downloadable': False}
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "cases": {
                    "edge_out": "_TissueSourceSiteDescribesCase_out",
