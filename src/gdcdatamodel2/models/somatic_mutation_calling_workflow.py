...
class SomaticMutationCallingWorkflow(base.Node):
    ...
    @psqlgraph.pg_property(str , enum=['CaVEMan', 'GATK4 MuTect2', 'GATK4 MuTect2 Tumor-Only', 'Lancet', 'Manta Indel', 'MuSE', 'MuTect2', 'Octopus', 'Pindel', 'Somatic Mutation Ensemble Workflow', 'SomaticSniper', 'Strelka2', 'Strelka2 RNA', 'SvABA Indel', 'VarDict', 'VarScan2'])
