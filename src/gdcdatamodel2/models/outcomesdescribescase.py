"""This module is for OutcomesDescribesCase Edge.
...
class OutcomesDescribesCase(base.Edge):
    __tablename__: str = "edge_outcomesdescribescase"
    ...
    __dst_src_assoc__: str = "outcomes"
