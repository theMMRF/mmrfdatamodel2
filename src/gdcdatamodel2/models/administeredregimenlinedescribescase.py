"""This module is for AdministeredRegimenLineDescribesCase Edge.
...
class AdministeredRegimenLineDescribesCase(base.Edge):
    __tablename__: str = "edge_c6af59f3_adrelideca"
    ...
    __dst_src_assoc__: str = "administered_regimen_line"
