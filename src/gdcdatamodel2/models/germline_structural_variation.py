"""This module is for GermlineStructuralVariation Node.
...
class GermlineStructuralVariation(base.Node):
    __tablename__: str = "node_germlinestructuralvariation"
    ...
    _dictionary: Dict[str, Union[bool, str, List[str]]] = {'title': 'Germline Structural Variation', 'namespace': 'https://gdc.cancer.gov', 'category': 'data_file', 'submittable': True, 'downloadable': True, 'description': 'Data file containing the germline structural variation data.', 'required': ['submitter_id', 'type', 'file_name', 'file_size', 'md5sum', 'data_category', 'data_format', 'data_type'], 'project': '*', 'program': '*', 'previous_version_downloadable': True}
    ...
    def get_label(cls) -> str:
        return "germline_structural_variation"
    ...
    def populate_pg_edges(cls) -> None:
        ...
        cls._pg_edges = {
                "core_metadata_collections": {
                    "backref": "germline_structural_variations",
                ...
                "germline_structural_variant_calling_workflows": {
                    "backref": "germline_structural_variations",
                    "type": base.Node.get_subclass("germline_structural_variant_calling_workflow"),
                },
        }
    ...
    def populate_pg_links(cls) -> None:
        ...
        cls._pg_links = {
                "core_metadata_collections": {
                    "edge_out": "_GermlineStructuralVariationDataFromCoreMetadataCollection_out",
                    "dst_type": base.Node.get_subclass("core_metadata_collection"),
                },
                "genomic_profile_harmonization_workflows": {
                    "edge_out": "_GermlineStructuralVariationDataFromGenomicProfileHarmonizationWorkflow_out",
                    "dst_type": base.Node.get_subclass("genomic_profile_harmonization_workflow"),
                },
                "germline_structural_variant_calling_workflows": {
                    "edge_out": "_GermlineStructuralVariationDataFromGermlineStructuralVariantCallingWorkflow_out",
                    "dst_type": base.Node.get_subclass("germline_structural_variant_calling_workflow"),
                },
        }
    ...
    @psqlgraph.pg_property(str , enum=['Germline Structural Variation', 'Structural Variation'])
...
datetime_hooks.cls_inject_created_datetime_hook(GermlineStructuralVariation)
datetime_hooks.cls_inject_updated_datetime_hook(GermlineStructuralVariation)
