"""This module is for SubmittedGenomicProfileDataFromCoreMetadataCollection Edge.
...
class SubmittedGenomicProfileDataFromCoreMetadataCollection(base.Edge):
    __tablename__: str = "edge_d8270df9_sugeprdafrcomeco"
