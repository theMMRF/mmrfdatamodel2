"""This module is for GermlineStructuralVariantCallingWorkflowRelatesToCase Edge.
...
class GermlineStructuralVariantCallingWorkflowRelatesToCase(base.Edge):
    __tablename__: str = "edge_4dfd09da_gestvacaworetoca"
    ...
    __dst_src_assoc__: str = "_related_germline_structural_variant_calling_workflow"
